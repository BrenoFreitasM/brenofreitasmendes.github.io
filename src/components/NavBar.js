...
export const  NavBar = () => {
  ...
  useEffect(() => {
    console.log('Estou renderrizando')
    const onScroll = () => {
      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            ...
            <Nav.Link href="#skills" className={activeLink === 'skills' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateaActiveLink('skills')}>Skills</Nav.Link>
